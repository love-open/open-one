...
/*jshint -W083 */
	...
	$.jstree.defaults.core = {
		...
		keyboard : {
			...
			'*': function (e) {
				// aria defines * on numpad as open_all - not very com.liu.common
				this.open_all();
			},
			'home': function (e) {
				// home
 ...
 */
	...
	$.jstree.defaults.state = {
		...
		filter	: false,
		/**
		 * Should loaded nodes be restored (setting this to true means that it is possible that the whole tree will be loaded for some user - use with caution). Defaults to `false`
